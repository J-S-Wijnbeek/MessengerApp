...
export default function Instellingen() {
          ...
          <div className="border-2 border-[#D9534F] rounded-lg p-4 mb-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Client sinds 2024</div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 rounded-lg p-4 mb-4">
              <div className="text-center text-gray-600 mb-2">Route naar client</div>
              <div className="h-32 bg-gray-200 rounded flex items-center justify-center">
                <span className="text-gray-500">Kaart</span>
              </div>
  ...
  return (
    <div className="min-h-screen bg-white pb-20 max-w-[390px] mx-auto relative">
      ...
      {/* Clients Section */}
      <SectionBar title="Gekoppelde Clienten" />
      <div className="px-4 py-4 border-b border-gray-100">
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700">
              {linkedClientsCount} van {maxClients} clienten gekoppeld
            </span>
          </div>
        ...
        >
          {isAtCapacity ? "Maximum bereikt" : "+ Koppel nieuwe client"}
        </button>
      </div>
        ...
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-2xl z-30 max-w-[390px] mx-auto">
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <h2 className="font-bold text-lg">Koppel nieuwe client</h2>
              <button
                onClick={closeLinkSheet}
      ...
      {showUnlinkConfirm && (
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-2xl z-50 max-w-[340px] w-full mx-4">
            <div className="p-6">
              <h3 className="font-bold text-lg mb-2">Client ontkoppelen?</h3>
              <p className="text-gray-600 text-sm mb-6">
                Weet je zeker dat je deze client wilt ontkoppelen? Deze actie kan niet ongedaan worden gemaakt.
              </p>
