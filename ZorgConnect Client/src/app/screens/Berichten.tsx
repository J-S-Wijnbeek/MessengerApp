...
export default function Berichten() {
  ...
  if (selectedChat) {
    ...
    const isStaffUnavailable = selectedStaffMember?.status === "niet-beschikbaar" || selectedStaffMember?.status === "achterwacht";
    ...
    <div className="min-h-screen bg-white pb-20 max-w-[390px] mx-auto relative">
      ...
      <div>
        {mockCoupledCareWorkers.map((worker, index) => {
          // Vary the status for demo purposes
